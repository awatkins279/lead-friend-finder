...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Lovable App" },
      { name: "description", content: "Lead Rocket is an all-in-one sales tool for lead generation, email outreach, and LinkedIn engagement." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Lovable App" },
      { property: "og:description", content: "Lead Rocket is an all-in-one sales tool for lead generation, email outreach, and LinkedIn engagement." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Lovable App" },
      { name: "twitter:description", content: "Lead Rocket is an all-in-one sales tool for lead generation, email outreach, and LinkedIn engagement." },
