...
export const MessageResponse = memo(
  ({ className, isAnimating: _isAnimating, ...props }: MessageResponseProps) => (
    <div
      className={cn(
        "size-full break-words [&>*:first-child]:mt-0 [&>*:last-child]:mb-0 [&_a]:text-accent [&_a]:underline [&_code]:rounded [&_code]:bg-muted [&_code]:px-1 [&_pre]:overflow-x-auto [&_pre]:rounded-md [&_pre]:bg-muted [&_pre]:p-3",
        className,
      )}
    >
