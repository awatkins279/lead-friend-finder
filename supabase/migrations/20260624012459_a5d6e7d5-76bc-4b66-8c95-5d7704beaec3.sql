...
REVOKE ALL ON FUNCTION public.backfill_leads_step(int) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.backfill_leads_step(int) TO anon, authenticated, service_role;
